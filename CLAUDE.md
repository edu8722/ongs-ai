...
- CONTRATO CONGELADO: el schema central tenant/ONG se decidirá en ADR-001; cuando exista,
  se congela aquí con nombre y ruta. Enums cerrados. Nunca se modifica sin ADR.
